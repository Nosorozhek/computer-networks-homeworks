...
#### Скрины
| ![](assets/moving_into_directory_filezilla.png) | ![](assets/uploading_file_filezilla.png) |
|-------------------------------------------------|------------------------------------------|
| ![](assets/creating_new_file_filezilla.png)     | ![](assets/deleting_file_filezilla.png)  |
...
| ![](assets/directory_listing_cli.png) | ![](assets/uploading_file_cli.png) ![](assets/orange_cat_on_server_proof_cli.png) | ![](assets/downloading_file_cli.png) |
| --------------------------------------|-----------------------------------------------------------------------------------|--------------------------|
...
| ![](assets/login_gui.png) | ![](assets/directory_listing_gui.png) | ![](assets/editing_file_gui.png) |
| --------------------------|---------------------------------------|-----------------------------------|
| ![](assets/uploading_file_gui.png) | ![](assets/reading_file_gui.png) | ![](assets/deleting_file_gui.png) |
